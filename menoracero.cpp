...
*numero1=0; //puntero numero1 sera igual a puntero numero2
cout<<"\nEl numero menor se ha intercambiado por '0'\n"; //mensaje de confirmacion

} //finalizacion del if
else if (*numero1>*numero2){ //iniio del if si numero1 es mayor a numero2

int aux=*numero2; // inicia una variable auxiliar y la iguala a puntero numero1
*numero2=0; //puntero numero1 sera igual a puntero numero2
cout<<"\nEl numero menor se ha intercambiado por '0'\n"; //mensaje de confirmacion
}
else
cout<<"\nLos numeros que digito son iguales\n"; //mensaje de confirmacion
} //Cierre de la funcion mayor
